...
const Campus = () => {
  return (
    <div className="w-full min-h-screen grid grid-rows-3 transition-all">
      <NavbarV2 />
      <main className="row-span-2 min-h-screen grid grid-cols-2 dark:bg-slate-900 bg-blue-300">
        ...
        <div className="col-span-2 grid grid-rows-2 w-full gap-3 p-2 place-content-center">
          <div className="row-span-1 bg-sky-200 flex flex-col m-auto md:m-0 p-4 rounded-lg  md:flex md:flex-row gap-2 md:overflow-x-auto items-center scrollbar">
            <h2 className="text-center ">Grupos Individuales</h2>
            <Card
          ...
          <div className=" row-span-2 bg-sky-200 flex flex-col pl-4 pt-4 pr-4 pb-3 m-auto md:m-0 rounded-lg  md:flex-row gap-2 md:overflow-x-auto items-center scrollbar ">
            <h2 className="text-center">Grupos grupales</h2>
            <Card
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/1280px-React-icon.svg.png"
              alt="react"
              h1="React"
